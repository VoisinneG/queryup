...
See this [web page](https://www.uniprot.org/help/uniprotkb_column_names) for all availbale UniProt data columns.
...
```{r message=FALSE, warnings=FALSE}
query <- list( "gene_exact" = "Pik3r1", "reviewed" = "yes", "organism_id" = "9606" )
...
```{r message=FALSE, warnings=FALSE}
query <- list( "gene_exact" = c("Pik3r1", "Pik3r2"), "reviewed" = "yes", "organism_id" = c("9606", "10090"))
df <- query_uniprot(query, show_progress = FALSE)
print(df)
```
